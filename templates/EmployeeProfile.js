class EmployeeProfile {
    ...
    setProfile() {
        ...
        if (this.title.toLowerCase() === 'manager') {
            this.html += `<img src="./img/employee1.PNG" class="card-img-top mt-5 img-fluid rounded mx-auto d-block"
                    alt="Employee Image" style="width: 50%;">`;
        } else {
            this.html += `<img src="./img/employee${this.setProfilePicture()}.PNG" class="card-img-top mt-5 img-fluid rounded mx-auto d-block"
                    alt="Employee Image" style="width: 50%;">`;
        }
